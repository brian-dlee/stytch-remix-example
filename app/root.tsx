...
export async function loader({ context, request }: LoaderFunctionArgs): Promise<LoaderData> {
  ...
  return {
    auth: {
      ...
      stytchUserId: session.get('stytchUserId') ?? null,
    },
  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta
          name="description"
          content="An example Remix application using Stytch for authentication"
        />
      ...
      <body
        ...
        style={{
          backgroundImage: 'radial-gradient( ellipse farthest-corner at 10px 10px, #f4e7f6, #f4e7f6 50%, #ffffff 50%)',
...
export default function App() {
  ...
  return (
    <div className="flex flex-col">
            ...
            <div className="flex">
              ...
              <div className="ml-6 flex items-center space-x-4">
                {data.auth.userId ? (
                  <Link
                    to="/profile"
                    aria-current={data.currentRoute === "/profile" ? 'page' : undefined}
                    className={clsx(
                      data.currentRoute === "/profile" ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white',
                  ...
                  <Link
                    to="/"
                    aria-current={data.currentRoute === "/" ? 'page' : undefined}
                    className={clsx(
                      data.currentRoute === "/" ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white',
                      'rounded-md px-3 py-2 text-sm font-medium',
                    )}
                  >
                    Home
                  ...
                  <div>
                    {data.auth.userId ? (
                      <div className="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                        ...
                        <img alt="" src="https://picsum.photos/64" className="size-8 rounded-full" />
                      </div>
                    ) : (
                      <button
                        type="button"
      ...
      <footer className="flex flex-col gap-x-10 bg-gray-900">
        <div className="mx-auto max-w-7xl overflow-hidden px-6 pt-16 pb-8 lg:px-8">
      ...
      <div
        className="flex flex-col p-5 pt-8"
      >
        <div className="flex flex-row h-[20px] justify-center items-center gap-4">
          <img
            src="/remix-logo.svg"
            alt="Remix"
